// QR 인식 대기 씬: MindAR 이미지 트래킹으로 Puzzle_ImageTracking(0)/Save_ImageTracking(1)
// 마커를 구분해서 각각 퍼즐(index.html)/고래구조(trash.html) 페이지로 이동한다.
// targets.mind는 MindAR 공식 컴파일러(hiukim.github.io/mind-ar-js-doc/tools/compile)로
// Puzzle_ImageTracking.png -> Save_ImageTracking.jpg 순서 그대로 업로드해서 만든 것 —
// targetIndex(0/1)가 TARGETS 배열 순서와 반드시 일치해야 한다.
